...
function importarUsandoBotao(){
  exibirInfos(JSON.parse(document.getElementById("textarea-json").value));
}
function exibirInfos(jsonArquivos,file){
  ...
  if(file!=null){
    ...
    insertOnTable1("ID", "Arquivo Importado");
